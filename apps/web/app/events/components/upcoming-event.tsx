...
const subEvents = [
  {
    title: "Clinical Ethics Workshop",
    date: "Aug 02, 2026",
  },
  {
    title: "Faith-Based Care Seminar",
    date: "Aug 10, 2026",
  },
  {
    title: "Spiritual Leadership Meet",
    date: "Aug 22, 2026",
  },
  {
    title: "Community Health Conference",
    date: "Sep 01, 2026",
  },
]
                  ...
                  <div className="group h-full rounded-2xl border bg-white shadow-md transition hover:shadow-xl">
                    <div className="p-5">
                      ...
                      <p className="mt-3 text-sm text-gray-500">
                        Learn from experts and join global leadership events.
                      </p>
