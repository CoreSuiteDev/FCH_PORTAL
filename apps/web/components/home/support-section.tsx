    ...
    <section className="overflow-hidden bg-[#b91c1c] py-24">
      <Container>
        <div className="grid items-stretch gap-8 md:grid-cols-2">
          ...
          <div className="group relative flex min-h-[450px] items-end overflow-hidden rounded-3xl p-10 shadow-2xl transition-all duration-500">
            {/* Background Image: Inline style to avoid Tailwind build errors */}
            <div
            ...
            <div className="relative z-10 translate-y-4 text-white transition-transform duration-500 group-hover:translate-y-0">
              <h3 className="mb-4 font-trajan text-3xl leading-tight tracking-wide md:text-4xl">
                {supportData.title}
              </h3>
          ...
          <div className="relative flex flex-col items-center justify-center rounded-3xl bg-white/95 p-10 text-center shadow-2xl backdrop-blur-sm transition-all duration-500">
            ...
            <h3 className="mb-6 font-trajan text-3xl tracking-wider text-[#8b0000]">
            ...
            <Button className="group relative overflow-hidden rounded-full bg-[#1a824e] px-10 py-7 text-lg text-white shadow-lg transition-all duration-300 hover:scale-105 hover:bg-[#156a40] hover:shadow-2xl">
