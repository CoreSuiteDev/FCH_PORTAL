...
const resourcesList = [
  ...
  },
  {
    ...
    description: "Explore curriculum tools, lesson plans, and classroom guides for religious education.",
    url: "/portal/resources/catechetical",
    icon: IconSchool,
    color: "text-emerald-600 bg-emerald-500/10 dark:text-emerald-400 dark:bg-emerald-950/20",
  },
  {
    title: "Pastoral Leadership",
    description: "Find resources for parish administration, ministry coordination, and leadership training.",
    url: "/portal/resources/leadership",
    icon: IconAward,
    color: "text-amber-600 bg-amber-500/10 dark:text-amber-400 dark:bg-amber-950/20",
  },
  {
    title: "Ministry Toolkits",
    description: "Download practical guides, templates, and toolkits for running active parish ministries.",
    url: "/portal/resources/toolkits",
    icon: IconBriefcase,
    color: "text-violet-600 bg-violet-500/10 dark:text-violet-400 dark:bg-violet-950/20",
  },
  {
    ...
    icon: IconHierarchy,
    color: "text-rose-600 bg-rose-500/10 dark:text-rose-400 dark:bg-rose-950/20",
  },
  {
