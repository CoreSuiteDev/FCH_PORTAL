      ...
      <div className="flex items-center justify-between space-y-2">
        <div>
          ...
          <p className="text-muted-foreground">
            Welcome to the FCH Member Portal. Access announcements, event signups, learning webinars, and basic resources.
          </p>
        </div>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="mt-2 list-inside list-disc space-y-1 text-muted-foreground">
              <li>Retrieve logged-in user context and display customized greetings (e.g. "Welcome back, John!").</li>
              <li>Render dynamic member badge status (Active, Expired, Canceled) by verifying Stripe/MemberPress webhooks inside DB.</li>
              <li>Setup widgets to show recent unread announcements, next event registration, and basic statistics.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {[
          ...
          },
          {
            ...
            description: "Download outreach templates, handbooks, and reference files.",
          },
          {
            title: "FCH General Documents",
            href: "/portal/documents",
            description: "Access bylaws, organizational policies, and safety guides.",
          },
          {
          ...
          >
            ...
            <div className="mt-5 flex items-center gap-1.5 text-xs font-semibold text-primary">
              Access Page <IconArrowRight className="size-3.5 group-hover:translate-x-0.5 transition-transform" />
            </div>
          </Link>
        ))}
      </div>
