...
export default function WebinarDetailsPage({ params }: PageProps) {
  ...
  if (error || !event || event.eventType !== "WEBINAR") {
    return (
      <div className="flex-1 flex flex-col items-center justify-center p-8 text-center space-y-4">
        <h3 className="text-xl font-bold">Failed to load webinar details</h3>
        <p className="text-muted-foreground max-w-md">
          This webinar may not exist or you may not have permissions to view it.
        </p>
        <button
          onClick={() => router.push("/portal/webinars")}
  ...
  return (
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      >
        <IconArrowLeft className="size-4" /> Back to Webinars
      </button>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {event.webinar?.speakers && event.webinar.speakers.length > 0 && (
            <div className="rounded-2xl border bg-card p-6 shadow-xs">
              <h3 className="text-lg font-bold tracking-tight mb-4 flex items-center gap-2">
                <IconUsers className="size-5 text-indigo-500" /> Webinar Speakers
              </h3>
          ...
          {registered && event.materials && event.materials.length > 0 && (
            <div className="rounded-2xl border bg-card p-6 shadow-xs">
              <h3 className="text-lg font-bold tracking-tight mb-4 flex items-center gap-2">
                <IconFileText className="size-5 text-emerald-500" /> Webinar Materials
              </h3>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-xs space-y-4">
            <h3 className="text-base font-bold tracking-tight">Webinar Status</h3>
            ...
            <div className="flex flex-col gap-3">
              {checkedIn ? (
                <div className="flex items-center gap-2 text-emerald-600 bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-3 text-xs font-bold">
                  <IconCheck className="size-5" /> You have checked in.
                </div>
              ) : registered ? (
                <div className="flex items-center gap-2 text-indigo-600 bg-indigo-500/10 border border-indigo-500/20 rounded-xl p-3 text-xs font-bold">
                  <IconCheck className="size-5" /> You are registered.
                </div>
              ) : (
                <div className="text-xs text-muted-foreground">
                  You are not registered. Register now to reserve your spot and receive the webinar links.
                </div>
              )}
          ...
          <div className="rounded-2xl border bg-card p-6 shadow-xs space-y-4">
            <h3 className="text-base font-bold tracking-tight">Webinar Details</h3>
