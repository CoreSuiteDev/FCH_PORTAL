  ...
  return (
    <div className="flex-1 space-y-6 p-8 pt-6">
      ...
      <div className="flex items-center justify-between space-y-2">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Internal Planning Workspace</h2>
          <p className="text-muted-foreground">
            Monitor strategic goals, annual timelines, diocese milestones, and implementation roadmaps.
          </p>
        </div>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="mt-2 list-inside list-disc space-y-1 text-muted-foreground">
              <li>Role Access check: Lock down access entirely to Board users.</li>
              <li>Setup timeline tracker: Build an interactive Kanban board or Gantt chart tracker (using library components like Dnd-Kit or React-Gantt).</li>
              <li>Integrate planning templates database to track milestones.</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {[
          ...
          <div key={index} className="rounded-lg border bg-card p-6 shadow-xs relative overflow-hidden">
            ...
            <div>
              <span className="text-xs font-semibold text-primary">{project.quarter} • {project.status}</span>
              <h3 className="text-lg font-bold tracking-tight mt-1">{project.title}</h3>
